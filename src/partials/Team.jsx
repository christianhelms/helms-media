      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2">The humans behind Helms Media</h2>
          </div>
          ...
          <div className="max-w-sm sm:max-w-5xl mx-auto sm:flex sm:flex-wrap sm:justify-center -my-6 sm:-my-8 sm:-mx-3" data-aos-id-team>
            ...
            <div className="sm:w-1/2 md:w-1/3 py-6 sm:py-8 sm:px-3" data-aos="zoom-y-out" data-aos-anchor="[data-aos-id-team]">
              <div className="flex flex-col items-center">
                <img className="rounded-full mb-4" src={ChristianHelms} width="120" height="120" alt="Team member 01" />
                <h4 className="text-xl font-bold mb-1">Christian Helms</h4>
                <div className="text-blue-600 font-medium mb-2">CEO & Founder</div>
                <p className="text-gray-600 text-center mb-3">I've always loved building websites. Heck, I built this one! Content creation and social media management are my passions.</p>
                <div className="text-sm text-gray-600 font-medium">
                  <a className="text-gray-900 hover:underline" href="https://twitter.com/ChristianmHelms">Twitter</a> · <a className="text-gray-900 hover:underline" href="https://github.com/christianhelms">GitHub</a> · <a className="text-gray-900 hover:underline" href="https://www.linkedin.com/in/christianhelms/">LinkedIn</a>
                </div>
              </div>
            </div>
